...
Considerando novamente os dados do SUS, use o comando `facet_grid` para mostrar as densidades de idade de falecimento quando separando os dados por gênero (coluna SEXO) e escolariedade (coluna ESC). DICA: remova os casos de NA (_Not Available_) encontrados em ambas colunas, SEXO e ESC.
